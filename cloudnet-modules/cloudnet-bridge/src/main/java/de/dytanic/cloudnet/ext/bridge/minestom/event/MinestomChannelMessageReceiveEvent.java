 ...
 * {@inheritDoc}
 */
public final class MinestomChannelMessageReceiveEvent extends
  MinestomCloudNetEvent implements
  WrappedChannelMessageReceiveEvent {

  private final ChannelMessageReceiveEvent event;

  public MinestomChannelMessageReceiveEvent(ChannelMessageReceiveEvent event) {
    this.event = event;
  }
